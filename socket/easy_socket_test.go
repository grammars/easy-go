...
func TestWebServer(t *testing.T) {
	t.Log("TestWebServer")
	srv := &WebServer[any]{Port: 6677, PrintDetail: false, Monitor: CreateMonitorStart("测试", 5000)}
	srv.StartDefault()
}

func TestWebServerTls(t *testing.T) {
	t.Log("TestWebServerTls")
	srv := &WebServer[any]{Port: 0, PrintDetail: false, Monitor: CreateMonitorStart("测试", 5000),
